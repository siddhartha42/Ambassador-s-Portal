  ...
  return (
    <div className="App">
      ...
      <div className="SubmissionBox">
        <p>submit your texts and links here</p>
        <div className="inputs">
          <input type="text" className="inputext" id="text"/>
          <img src="https://flyclipart.com/thumb2/camera-icon-png-594865.png"></img>
        </div>
